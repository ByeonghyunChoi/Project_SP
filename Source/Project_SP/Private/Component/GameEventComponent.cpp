...
void UGameEventComponent::BroadcastDamageFinalized(ACombatPawn* DamagedPawn, float DamageAmount, EDamageFloaterType DamageType, ACombatPawn* InstigatorPawn){ OnDamageFinalized.Broadcast(DamagedPawn, DamageAmount, DamageType, InstigatorPawn); }
